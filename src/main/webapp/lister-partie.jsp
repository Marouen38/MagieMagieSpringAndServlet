...
<html lang="fr">
    ...
    <body>
        ...
        <div class="main">
            <a href="<c:url value="/creer-partie"/>"><button class="btnCreeP">Créer partie</button></a>
            <ul class="listePartie">
                <c:forEach items="${liste}" var="partie">
                    <li class="partie">
                        <h3>${partie.nom}</h3>
                        <p>${partie.joueurs.size()}</p>
                        <a href="<c:url value="/rejoindre-partie?partieId=${partie.id}"></c:url>">
                            <button class="btnCree" name="rejoindrePartie">Rejoindre</button>
                        </a>
